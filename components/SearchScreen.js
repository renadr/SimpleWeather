        ...
        return(
            <View style={{flex:1}}>
                <View style={{flex:1,flexDirection:'row',alignItems: 'center',justifyContent: 'center',padding:5}}>
                    ...
                    <TextInput style={styles.input} underlineColorAndroid='rgba(0,0,0,0)' placeholder="Entrez votre ville ici..." autoFocus onChange={(cities) => APIManager.getCityFromSearchBar(this)}/>
                    </View>
                </View>
                <View style={{flex:8}}>
                {console.log(APIManager.getSearchBarCities())}
                </View>
            </View>
